...
namespace DimensionCalculator.Compound_Interest
{
    ...
    /// </summary>
    //====================================================\\
    //COMPOUND INTEREST - CALCULATING A (PAGE)
    //====================================================\\
    public sealed partial class CompoundInterest_A : Page
    {
        //====================================================\\
        //==================(My global variables)==================\\
        double a =0;
        ...
        {
            this.Frame.Navigate(typeof(CompoundInterest)); //To the compound interest main page
        }
        //====================================================\\
        //==================(My calculation button)==================\\ - once it is clicked it shows the value
        private void btnCal_ci_A_Click(object sender, RoutedEventArgs e)
        {
            //this section of code might throw an error
            try
            {
                //assigning the local variables to the text that the user provides
                p = Convert.ToDouble(txtP_ci_A.Text);
                i = Convert.ToDouble(txtI_ci_A.Text);
                n = Convert.ToDouble(txtN_ci_A.Text);
                ...
                if (comboBox_compoundint_A.SelectedIndex == 0)
                {
                    i = i / 100;  //making i over 100
                    Com outPut = new Com(a,p,i,n); //instance of the class (Com)
                    txtOutput_ci_A.Text = Convert.ToString(outPut.calc_A(a, p, i, n)).ToString(); //output the result to the textbox
                ...
                //making half a year.
                else if (comboBox_compoundint_A.SelectedIndex == 1)
                {
                    n = n * 2; //making i over 200
                    i = i / 200; //multiplying n by 2
                    Com outPut = new Com(a, p, i, n);  //instance of the class (Com)
                    txtOutput_ci_A.Text = Convert.ToString(outPut.calc_A(a, p, i, n)).ToString(); //output the result to the textbox
                }
                ////if it is monthly it should change the calculation by changing the i value over 1200 and times the number of years by 12
                //making it monthly
                else if (comboBox_compoundint_A.SelectedIndex == 2)
                {
                ...
                //making it quarterly
                else if (comboBox_compoundint_A.SelectedIndex == 3)
                {
            ...
            {
                txtOutput_ci_A.Text = c.Message; //outputs the message of the exception
            }
        ...
        {
            //double me = Math.Pow(123, 2);
            //txtOutput_ci_A.Text = Convert.ToString(me);
        }
        //====================================================\\
        //==================(My reset button)==================\\
        private void btnReset_ci_A_Click(object sender, RoutedEventArgs e)
        {
            ...
            txtP_ci_A.Text = "";
            txtOutput_ci_A.Text = "";
            comboBox_compoundint_A.SelectedIndex = -1;
        }
        //====================================================\\
    }
}
